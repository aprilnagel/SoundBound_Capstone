...
import "../../AdminDash/AdminAppDetails/AdminAppDetails.css";

export default function MyAppDetails() {
  ...
  return (
    <div className="admin-app-details-page">
      ...
      <div className="admin-app-details-card">
        ...
        {/* Optional: show review info if exists */}
        {application.reviewed_at && (
          <div className="details-section">
            ...
            {application.reviewed_by && (
              <p>
                <strong>Reviewed By:</strong> {application.reviewed_by}
              </p>
            )}
            {application.notes && (
              <p>
